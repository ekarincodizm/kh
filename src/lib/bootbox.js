...
(function (root, factory) {
  ...
  var templates = {
    ...
    inputs: {
      ...
      datetime:
        "<input class='bootbox-input bootbox-input-datetime form-control' autocomplete=off type='datetime-local' />",
      time:
  ...
  exports.form = function() {
    ...
    var innerDialog = form.find(".modal-dialog");
    console.log('options=',options.size,innerDialog);    
      if (options.size === "large") {
        let rs =innerDialog.addClass("modal-lg");
        console.log('addclass large',rs);
