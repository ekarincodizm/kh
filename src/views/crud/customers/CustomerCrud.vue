              ...
              <div class="box box-default">
                  ...
                  <div class="box-body">
                      <table class="table table-bordered table-striped dataTable">
                        ...
                        <tbody v-else>
                          <tr><td style="text-align:center;" :colspan="colslength"><b>No data</b></td></tr>
                        </tbody>
                        <tfoot>
                          <tr>
...
export default {
  ...
  //----------------------INIT -----
          const cols = [
              { key: 'id',          readonly:1, default:'',inputtype: 'text', sortable: 1, visible: 1, classname:'center' ,width: null, label: 'id',           },
              { key: 'product_code',readonly:0, default:'',inputtype: 'text', sortable: 1, visible: 1, classname:'center' ,width: null, label: 'product code', },
              { key: 'shortcode',   readonly:0, default:'',inputtype: 'text', sortable: 0, visible: 1, classname:'center' ,width: null, label: 'shortcode',    },
              { key: 'name',        readonly:0, default:'',inputtype: 'text', sortable: 1, visible: 1, classname:'left'   ,width: null, label: 'name',         },
  ...
  computed:{
    ...mapGetters({datas:'customers/customers'}),
    totalpage() {
