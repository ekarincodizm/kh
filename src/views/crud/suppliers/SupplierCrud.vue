...
export default {
  ...
  //----------------------INIT -----
const cols = [
  { key:'id',          readonly:1, default:'',inputtype: 'text',     sortable: 1, visible: 0, classname:'center' ,width: 100, label:'id',         },
  { key:'cus_code',    readonly:0, default:'',inputtype: 'text',     sortable: 1, visible: 1, classname:'let'    ,width: 150, label:'cus_code',   },
  { key:'name',        readonly:0, default:'',inputtype: 'text',     sortable: 1, visible: 1, classname:'left'   ,width: 250, label:'name',       },
  { key:'short_name',  readonly:0, default:'',inputtype: 'text',     sortable: 0, visible: 1, classname:'left'   ,width: 200, label:'short_name', },
  { key:'cus_id',      readonly:0, default:'',inputtype: 'textarea', sortable: 1, visible: 1, classname:'left'   ,width: 200, label:'cus_id',     },
  { key:'address1',    readonly:0, default:'',inputtype: 'textarea', sortable: 0, visible: 0, classname:'left'   ,width: 200, label:'address1',   },
  { key:'address2',    readonly:0, default:'',inputtype: 'textarea', sortable: 0, visible: 0, classname:'left'   ,width: 200, label:'address2',   },
  { key:'tel',         readonly:0, default:'',inputtype: 'text',     sortable: 0, visible: 0, classname:'left'   ,width: 200, label:'tel',        },
  { key:'email',       readonly:0, default:'',inputtype: 'text',     sortable: 0, visible: 0, classname:'left'   ,width: 200, label:'email',      },
  { key:'fax',         readonly:0, default:'',inputtype: 'text',     sortable: 0, visible: 0, classname:'left'   ,width: null, label:'fax',        },
  { key:'remark',      readonly:0, default:'',inputtype: 'textarea', sortable: 0, visible: 0, classname:'center' ,width: null, label:'remark',     },
  { key:'description', readonly:0, default:'',inputtype: 'text',     sortable: 0, visible: 0, classname:'center' ,width: null, label:'description',},
  { key:'created_at',  readonly:1, default:'',inputtype: 'text',     sortable: 0, visible: 0, classname:'center' ,width: null, label:'created_at', },
  { key:'created_by',  readonly:1, default:'',inputtype: 'text',     sortable: 0, visible: 0, classname:'center' ,width: null, label:'created_by', },
  { key:'updated_at',  readonly:1, default:'',inputtype: 'text',     sortable: 0, visible: 0, classname:'center' ,width: null, label:'updated_at', },
  { key:'updated_by',  readonly:1, default:'',inputtype: 'text',     sortable: 0, visible: 0, classname:'center' ,width: null, label:'updated_by', },           
];
        let sortorders = {};
  ...
  computed:{
    ...mapGetters({datas:'suppliers/suppliers'}),
    totalpage() {
