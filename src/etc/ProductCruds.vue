                ...
                <div class="xcrud-list-container">
                    ...
                    <div class="row">
                        <table class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info"">
                            ...
                            <tbody>
                                <tr role="row" class="xcrud-row xcrud-row-0" v-for="(item,index) in filters()">
                                    <td class="xcrud-current xcrud-num">{{index+1}}</td>
                                    <td v-for="row in item">{{row}}</td>
                                    <td class="xcrud-current xcrud-actions xcrud-fix">
                                        <span>
                                            <router-link v-bind:to="'/system/product/' + index" class="btn xcrud-action xcrud-button xcrud-cyan"><i class="glyphicon glyphicon-info-sign"></i></router-link>
                                            <router-link v-bind:to="'/system/product/edit/' + index " class="btn xcrud-action xcrud-button xcrud-orange"><i class="glyphicon glyphicon-pencil"></i></router-link>
                                            <a @click="delitem(item)" class="btn xcrud-action xcrud-button xcrud-orange"><i class="glyphicon glyphicon-trash"></i></a>
                                        </span>
                                    </td>
                                </tr>
                            </tbody>
